...
const sponsorSlots = [
  { slot: "Titan Sponsor", desc: "Premium tech server provider" },
  { slot: "Pixel Partner", desc: "Graphics & UI console asset designer" },
  { slot: "Hacker Fuel", desc: "Beverages powering local compilations" },
  { slot: "Cyber Security Hub", desc: "JWT & database defense alliance" },
];

const faqs = [
  {
    question: "What is BuildX and who can participate?",
    answer:
      "BuildX is a high-octane 80s arcade & retro themed coding hackathon for developers, designers, and students who want to build cool products, test their skill limits, and break production records.",
  },
  {
    question: "How can I register? Is there a participation fee?",
    answer:
      "Fill out the registration form with your details and upload a screenshot proof of the registration payment slip. An administrator will review your receipt and approve your account shortly.",
  },
  {
    question: "Where can I find the official timeline?",
    answer:
      "Our milestone timeline is detailed below. The live quiz will happen in real-time right here on this website. Make sure to log in to access the active waiting rooms.",
  },
  {
    question: "How do I access the live quiz app?",
    answer:
      "Once an admin verifies your payment verification receipt, click the 'QUIZ' button in the navigation bar, put in the active host join code, and enter the lobby to participate.",
  },
];
      ...
      <main className="relative z-10">
          ...
          <div className="container grid gap-8 lg:grid-cols-[1fr_1.2fr_0.8fr] relative z-10 items-center">
            ...
            <div className="space-y-4">
              <p className="text-sm leading-relaxed text-muted-foreground uppercase">
                BuildX represents the ultimate testing ground for engineering limits. Designed as a retro-futuristic arcade hacker experience, we gather code artisans to collaborate, design, and push software boundaries within tight time frames.
              </p>
              <p className="text-sm leading-relaxed text-muted-foreground uppercase">
                Through customized JWT security architectures, automated Multer payment slips uploads, and high-frequency Socket.IO real-time pipelines, this portal serves as your command central for verification status and tournament execution.
              </p>
            </div>
            <div className="flex justify-center">
              <img src="/images/retro_hero.png" alt="BuildX Retro Arcade Console" className="w-48 h-48 border border-primary/30 rounded shadow-pink object-cover" />
            </div>
          </div>
        </section>
        ...
        <section id="sponsors" className="bg-[#0b0914] border-y border-primary/20 py-20 relative">
          ...
          <div className="container relative z-10">
            ...
            <h2 className="mt-1 font-display text-4xl font-bold text-white text-center mb-10">SUPPORTING_HOSTS</h2>
        ...
        <section id="contactus" className="container py-20 space-y-12">
          ...
          <div className="flex flex-col gap-2">
            <p className="text-xs font-bold uppercase tracking-widest text-primary text-neon-pink">SYS_HOTLINE</p>
        ...
        <div className="container grid gap-8 md:grid-cols-[1.5fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-3 max-w-sm text-xs leading-relaxed text-muted-foreground uppercase">
              Terminal interface for the BuildX registration and quiz network. All codes compiled locally. Secure JWT cookies transport layer enabled.
            </p>
          ...
          <div>
            <h3 className="font-bold text-secondary uppercase tracking-widest text-sm mb-4">MAP_NODES</h3>
