    ...
    <header className="sticky top-0 z-40 border-b border-primary/30 bg-[#07060c]/90 backdrop-blur-md">
      <nav className="container flex h-16 items-center justify-between gap-4">
        ...
        <div className="hidden items-center gap-6 text-sm font-bold tracking-widest md:flex font-terminal">
          ...
          <button
            onClick={() => alert("Quiz portal deactivated for preview mode.")}
            className="flex items-center gap-1 text-muted-foreground transition hover:text-secondary hover:text-neon-cyan font-terminal font-bold bg-transparent border-none outline-none focus:outline-none"
          >
